...
v2ray_config(){
  # while :; do	
  # echo -e "请输入 V2Ray 端口，不能选择 80 或 443 端口"
  #     read -p "$(echo -e "(默认端口: 10009):")" v2ray_port
  #     [ -z "$v2ray_port" ] && v2ray_port=10009
  #     case $v2ray_port in
  #     80)
  #       echo
  #       echo " ...能选择 80 端口....."
  ...
  # UUID=''
  printf '{\n\t"inbounds":[{\n\t\t"port":10009,\n\t\t"protocol":"vmess",\n\t\t"settings":{\n\t\t\t"clients":[{\n\t\t\t\t"id":"53828971-7699-407d-b8f8-7f79301ae20c"\n\t\t\t}]\n\t\t}\n\t}],\n\t"outbounds":[{\n\t\t"protocol":"freedom"\n\t}]\n}\n' > /usr/local/etc/v2ray/config.json
  # echo -e "The v2ray port is: $yellow $v2ray_port"
}
main() {
  check_if_running_as_root
  identify_the_operating_system_and_architecture
  ...
  echo "The configuration file is being automatically generated"
  v2ray_config
  echo "You may need to execute a command to remove dependent software: $PACKAGE_MANAGEMENT_REMOVE curl unzip"
...
# 2d31b7f8-4f05-43fc-a36a-5a533f208a57
